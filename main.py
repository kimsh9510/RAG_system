...
from models import load_llm, load_solar_pro, load_EXAONE, load_llama3, load_solar_pro2
...
llm = load_solar_pro2() # or load_solar_pro(), load_EXAONE(), load_llama3(), load_llm()
